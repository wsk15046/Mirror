...
namespace Mirror
{
    ...
    public static class NetworkClient
    {
        ...
        {
            Transport.activeTransport.OnClientConnected.AddListener(OnConnectedInternal);
            Transport.activeTransport.OnClientDataReceived.AddListener(OnDataReceived);
            Transport.activeTransport.OnClientDisconnected.AddListener(OnDisconnectedInternal);
        ...
        static void RemoveTransportHandlers()
        {
            ...
            Transport.activeTransport.OnClientConnected.RemoveListener(OnConnectedInternal);
            Transport.activeTransport.OnClientDataReceived.RemoveListener(OnDataReceived);
            Transport.activeTransport.OnClientDisconnected.RemoveListener(OnDisconnectedInternal);
